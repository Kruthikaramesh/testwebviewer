...
export default class App extends React.Component<AppProps, AppState> {
    ...
    constructor(props: AppProps) {
        ...
        const usdAssets: USDAssetType[] = StreamConfig.source === "stream"? [
            { name: "Boiler", url: "http://localhost:8080/Boiler/Boiler_1_1.usd" },
            { name: "Forklift", url: "http://omniverse-content-production.s3-us-west-2.amazonaws.com/Assets/DigitalTwin/Assets/Warehouse/Equipment/Forklifts/Forklift_A/Forklift_A01_PR_V_NVD_01.usd" },
                        { name: "Sample 1", url: "/app/samples/stage01.usd" },
                        { name: "Sample 2", url: "/app/samples/stage02.usd" },
                        { name: "parking lot", url: "http://localhost:8080/abandoned_parking_lot.usd" },
                        { name: "Forklift", url: "http://omniverse-content-production.s3-us-west-2.amazonaws.com/Assets/DigitalTwin/Assets/Warehouse/Equipment/Forklifts/Forklift_A/Forklift_A01_PR_V_NVD_01.usd" },
                        { name: "Sample 4", url: "http://localhost:8080/Electrical_Panel_new_2.usd" },
                        { name: "Sample 6", url :"http://omniverse-content-production.s3-us-west-2.amazonaws.com/Assets/ArchVis/Industrial/Buildings/Warehouse/Warehouse01.usd"},
                        { name: "Sample 7" , url: "C:/Users/Administrator/Downloads/Assets/Characters/Reallusion/Debra/Materials/Cat_Suit_belt.usd"}
                        ]
                        :
                        [
                            { name: "Boiler", url: "http://localhost:8080/Boiler/Boiler_1_1.usd" },
